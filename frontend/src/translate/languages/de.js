  ...
  de: {
    translations: {
      common: {
        ...
        emptyDescription:
          "Einträge erscheinen in dieser Liste, sobald es welche gibt.",
        emptySearchTitle: "Keine Ergebnisse",
        emptySearchDescription:
          "Nichts passt zu Ihrer Suche. Versuchen Sie einen anderen Begriff.",
        edit: "Bearbeiten",
        delete: "Löschen",
        cancel: "Abbrechen",
        save: "Speichern",
      ...
      trialBanner: {
        daysLeft: "Ihre kostenlose Testphase endet in {{count}} Tagen",
        tomorrow: "Ihre kostenlose Testphase endet morgen",
        today: "Ihre kostenlose Testphase endet heute",
        ended: "Ihre kostenlose Testphase ist beendet",
      ...
      contacts: {
        ...
        buttons: {
          importCsv: "Aus CSV-Datei importieren",
      ...
      settings: {
        appearance: {
          ...
          title: "Farbthema",
          subtitle:
            "Wählen Sie die Systemfarben für Ihr ganzes Team. Die Änderung erscheint sofort bei allen.",
          mode: "Modus",
          light: "Hell",
          dark: "Dunkel",
          custom: "Eigene",
          customDescription: "Nutzen Sie Ihre Markenfarbe",
          restore: "Standard wiederherstellen",
          applied: "Thema für das ganze Team übernommen",
          restored: "Standardfarben wiederhergestellt",
          current: "Aktiv",
          presets: {
            tekvosoft: {
              name: "Tekvosoft Lila",
            ...
            classicBlue: {
              name: "Klassisch Blau",
              description: "Professionelles, seriöses Blau"
            },
            forestGreen: {
              name: "Waldgrün",
              description: "Von der Natur inspiriertes Grün"
            },
            oceanTeal: {
              name: "Ozeangrün",
              description: "Erfrischendes Petrol"
            },
            sunsetOrange: {
              name: "Sonnenuntergang",
              description: "Warme Orange- und Bernsteintöne"
            },
            nightPurple: {
              name: "Nachtlila",
              description: "Tiefes, elegantes Lila"
            },
            roseRed: { name: "Rosé", description: "Kräftiges, edles Pink" },
            cosmic: {
              name: "Kosmisch",
              description: "Indigo, inspiriert vom Weltraum"
            }
          }
        },
        restartBackend: {
      ...
      contactDrawer: {
        ...
        phone: {
          ...
          copyFailed: "Nummer konnte nicht kopiert werden",
          schedule: "Planen",
          notes: "Notizen",
          email: "E-Mail",
          tags: "Tags",
      ...
      backendErrors: {
        ERR_TRANSCRIPTION_DISABLED:
          "Audio-Transkription ist deaktiviert oder kein KI-Schlüssel konfiguriert.",
        ERR_TRANSCRIPTION_FAILED: "Audio konnte nicht transkribiert werden.",
        ERR_NOT_AUDIO: "Diese Nachricht ist kein Audio.",
        ERR_INTERNAL:
        ...
        ERR_USER_INACTIVE:
          "Ihr Zugang ist deaktiviert. Wenden Sie sich an den Administrator Ihres Unternehmens.",
