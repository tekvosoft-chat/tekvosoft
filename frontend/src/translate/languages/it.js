  ...
  it: {
    translations: {
      common: {
        ...
        emptyDescription:
          "I record appariranno in questo elenco non appena ce ne saranno.",
        emptySearchTitle: "Nessun risultato",
        emptySearchDescription:
          "Nulla corrisponde alla tua ricerca. Prova un altro termine.",
        edit: "Modifica",
        delete: "Elimina",
        cancel: "Annulla",
        save: "Salva",
      ...
      trialBanner: {
        daysLeft: "La tua prova gratuita termina tra {{count}} giorni",
        tomorrow: "La tua prova gratuita termina domani",
        today: "La tua prova gratuita termina oggi",
        ended: "La tua prova gratuita è terminata",
        cta: "Abbonati ora"
      },
      mediaPreview: {
        files: "file",
      ...
      about: {
        ...
        product:
          "vuup.me è una piattaforma di assistenza clienti su WhatsApp che riunisce il tuo team in un unico posto: conversazioni, code, chatbot, Kanban e chat interna.",
        founder:
          "Sono David Fernandes, ho 22 anni e sono un imprenditore nel settore della tecnologia.",
        improving:
          "Miglioro vuup.me continuamente: ogni aggiornamento porta correzioni e novità per rendere più semplice il lavoro quotidiano di chi assiste i clienti.",
        founderRole: "Fondatore di vuup.me",
        license: "Software libero con licenza AGPL-3.0.",
        sourceCode: "Codice sorgente",
        aboutthe: "Informazioni su",
        copyright: "© 2024 - Funzionante con vuup.me",
        buttonclose: "Chiudi",
        title: "Informazioni su vuup.me",
        abouttitle: "Origine e miglioramenti",
        aboutdetail:
          "vuup.me è derivato indirettamente dal progetto Whaticket con miglioramenti condivisi dagli sviluppatori del sistema EquipeChat attraverso il canale VemFazer su YouTube, successivamente migliorati da Claudemir Todo Bom",
        ...
        licensedetail:
          "vuup.me è concesso in licenza sotto la GNU Affero General Public License versione 3, il che significa che qualsiasi utente che ha accesso a questa applicazione ha il diritto di ottenere l'accesso al codice sorgente. Maggiori informazioni nei link sottostanti:",
        licensefulltext: "Testo completo della licenza",
        licensesourcecode: "Codice sorgente di vuup.me"
      },
      schedules: {
        calendar: {
          subtitle:
      ...
      settings: {
        appearance: {
          ...
          title: "Tema colori",
          subtitle:
            "Scegli i colori del sistema per tutto il team. La modifica appare subito sullo schermo di tutti.",
          mode: "Modalità",
          light: "Chiaro",
          dark: "Scuro",
          custom: "Personalizzato",
          customDescription: "Usa il colore del tuo brand",
          restore: "Ripristina predefinito",
          applied: "Tema applicato a tutto il team",
          restored: "Colori predefiniti ripristinati",
          current: "In uso",
          presets: {
            tekvosoft: {
              name: "Bianco e nero",
              description: "L'identità predefinita di vuup.me: pulita e neutra"
            },
            brandPurple: {
              name: "Viola",
              description: "Viola vivace e moderno"
            },
            classicBlue: {
              name: "Blu Classico",
              description: "Blu professionale, sobrio e affidabile"
            },
            forestGreen: {
              name: "Verde Foresta",
              description: "Verde ispirato alla natura"
            },
            oceanTeal: {
              name: "Verde Oceano",
              description: "Petrolio rinfrescante ispirato al mare"
            },
            sunsetOrange: {
              name: "Arancio Tramonto",
              description: "Toni caldi di arancio e ambra"
            },
            nightPurple: {
              name: "Viola Notte",
              description: "Viola profondo ed elegante"
            },
            roseRed: {
              name: "Rosa",
              description: "Rosa intenso e sofisticato"
            },
            cosmic: {
              name: "Cosmico",
              description: "Indaco ispirato allo spazio"
            }
          }
        },
        restartBackend: {
      ...
      contactDrawer: {
        ...
        phone: {
          ...
          copyFailed: "Impossibile copiare il numero",
          schedule: "Pianifica",
          notes: "Note",
          email: "E-mail",
          tags: "Tag",
      ...
      backendErrors: {
        ...
        ERR_USER_INACTIVE:
          "Il tuo accesso è disattivato. Contatta l'amministratore della tua azienda.",
